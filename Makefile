...
# Project:  ..\chess\chess.pro
# Template: app
# Command: D:\Qt\Qt5.8.0\5.8\mingw53_32\bin\qmake.exe -o Makefile ..\chess\chess.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: ../chess/chess.pro ../../Qt/Qt5.8.0/5.8/mingw53_32/mkspecs/win32-g++/qmake.conf ../../Qt/Qt5.8.0/5.8/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile ..\chess\chess.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
